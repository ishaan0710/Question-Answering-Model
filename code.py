# -*- coding: utf-8 -*-
"""
Created on Sat Mar  2 16:49:55 2019
    ...
    with open(set_file, "r", encoding="utf8") as train:
        for line in train:
            ...
            if "\t" in r_line: 
                ...
                question, answer, support = tuple(r_line.split("\t"))
                ...
                # Context sentence.
                context.append(sentence2sequence(r_line[:-1]))
    return data
